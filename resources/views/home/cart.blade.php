...
<li class="cart_item clearfix">
    <div class="cart_item_image"><img src="uploads/" alt=""></div>
    <div class="cart_item_info d-flex flex-md-row flex-column justify-content-between">
        ...
        <div class="cart_item_total cart_info_col">
            ...
            <div class="cart_item_text">${{$cart->product->price * $cart->qty}}</div>
        </div>
        <div class="cart_item_action cart_info_col">
            <div class="cart_item_title">Remove</div>
            <div class="cart_item_text">
                <a href="handelers/remove.php?id=">
        ...
        <div class="row">
            <div class="col-lg-10 offset-lg-1">
                <div class="contact_form_container">
                    ...
                    <form action='{{url("/order/store")}}' method="POST" id="order_form">
                        @csrf
